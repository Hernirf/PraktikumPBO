...
public  final class  Main {
    ...
    public static final void loker(LokerHewan hewan) throws IOException{
    ...
    public static final void loker(LokerBarang barang) throws IOException{
        while(true){
            System.out.println(" ");
    ...
    public static final void menu() throws IOException {
        while(true){
            System.out.println(" ");
    ...
    public static final void add(LokerHewan hewan1) throws IOException{
        nomor_loker_hewan += 1;
    ...
    public static final void add(LokerBarang barang1) throws IOException{
    ...
    public static final void read(LokerHewan hewan1) throws IOException{
    ...
    public static final void read(LokerBarang barang1) throws IOException{
    ...
    public static final void update(LokerHewan hewan1) throws IOException{
        read(hewan1);
        int kondisi = 0;
    ...
    public static final void update(LokerBarang barang1) throws IOException{
        read(barang1);
        int kondisi = 0;
        System.out.print("Masukkan nomor loker yang ingin diubah: ");
        int idx = Integer.parseInt(br.readLine());
    ...
    public static final void delete(LokerHewan hewan1) throws IOException{
        read(hewan1);
        int kondisi = 0;
    ...
    public static final void delete(LokerBarang barang1) throws IOException{
        read(barang1);
        int kondisi = 0;
        System.out.print("Masukkan nomor loker yang ingin dihapus: ");
        int idx = Integer.parseInt(br.readLine());
