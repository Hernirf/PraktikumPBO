public class LokerHewan extends Loker{
    ...
    public LokerHewan(String tanggal, int harga, int jumlahhari,int nomor_loker, String jenis_hewan, String nama_hewan, String id_user) {
